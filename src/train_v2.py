...
import os
import collections
from data_loader_v2 import get_dataset

tf.config.run_functions_eagerly(True)
tf.data.experimental.enable_debug_mode()

top_level_dir_path = 'D:\\173_seeding_harvest_joined_USCA_mini.parquet'
...
train_files = [x for x in lowest_dirs if ('8348b' in  x)]
...
train_ds = get_dataset(train_files_positive,shuffle_buffer=2000000,batch_size=batch_size, crop_season_only=crop_season_only, num_hexes_per_field=num_hexes_per_field,
