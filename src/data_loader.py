...
def get_dataset(dir_paths, batch_size, num_bands=12, shuffle_buffer=200000, crop_season_only=False,
    ...
    def parse(row, fop):
        ...
        tf.print('split_scenes', split_scenes)
    ...
    def image_selector_proc_fn(*input_val):
        print('image_selector_proc_fn start', input_val)
    ...
    print_paths_shuffled = False
    if print_paths_shuffled:
        for d in ds:
            print(d)
